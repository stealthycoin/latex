...
hashes = pickle.load(open('save.p','rb'))
...
cmps = [["I", ""],
        ...
        ["for"],
        ["1 Million dollars", "one million dollars", "1 million dollars", "$1 million", "$1 Million"],
        ["on"],
        ["Feb.", "Febuary", "Feb"],
        ["2","3","4","5","6","7","8"],
        ["2014"]]
                                                            ...
                                                            for p in cmps[15]:
                                                                for q in cmps[16]:
                                                                    for r in cmps[17]:
                                                                        ...
                                                                        try:
                                                                            hashcode = hashlib.sha1(msg).hexdigest()[-10:]
                                                                            realMsg = hashes[hashcode]
                                                                            #no error so a collision
                                                                            print "%s\n%s\n%s" % (msg, realMsg, hashcode)
                                                                            print "\n"
                                                                        except KeyError:
                                                                            pass #who cares we are looking for a collision
